        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-gray-900 rounded-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400">rupees, forever</p>
            </div>
            ...
            <a
              ...
              className="block w-full bg-white text-gray-900 text-center py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
            >
              Get Started Free
            </a>
          </div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="bg-green-50 border-b border-green-200">
                    ...
                    <td className="py-4 px-6 font-bold text-green-700">0</td>
                    <td className="py-4 px-6 text-green-700">Unlimited</td>
                  </tr>
                  {competitors.map((competitor) => (
                    <tr key={competitor.name} className="border-b border-gray-100">
                      <td className="py-4 px-6 text-gray-900">{competitor.name}</td>
                      <td className="py-4 px-6 text-red-600 font-medium">{competitor.price}</td>
                      <td className="py-4 px-6 text-gray-600">{competitor.properties}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
