            ...
            <div>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="bg-green-50 border-b border-green-200">
                      ...
                      <td
                        className="py-3 px-4 font-bold text-green-700 text-sm"
                        data-tabular
                      >
                        0
                      </td>
                    ...
                    {competitors.map((competitor) => (
                      ...
                      >
                        ...
                        <td
                          className="py-3 px-4 text-red-600 font-medium text-sm"
                          data-tabular
                        >
                          {competitor.price}
                        </td>
              ...
              <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
                <p className="text-sm text-yellow-800">
                  Why pay 3,600 to 12,000 rupees per year when you can get
                  everything for free?
                </p>
              </div>
            </div>
