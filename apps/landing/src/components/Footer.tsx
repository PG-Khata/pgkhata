    ...
    <footer className="py-16 bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div>
            <h3 className="text-xl font-bold text-gray-900 mb-4">PGKhata</h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              ...
              <li><a href="https://app.pgkhata.com" className="hover:text-gray-900 transition-colors">Login</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              <li><a href="mailto:support@pgkhata.com" className="hover:text-gray-900 transition-colors">support@pgkhata.com</a></li>
              <li><a href="https://wa.me/918294495929" className="hover:text-gray-900 transition-colors">WhatsApp Support</a></li>
            </ul>
          </div>
        </div>
