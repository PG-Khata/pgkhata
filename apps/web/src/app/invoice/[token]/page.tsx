...
type PublicInvoice = { invoice: { month: string; rentPeriodStart?: string | null; rentPeriodEnd?: string | null; lineItems: Array<{ code: string; name: string; amount: number }>; totalAmount: number; paidAmount: number; balance: number; status: string; dueDate?: string | null; tenantName: string; propertyName: string; roomNumber?: string | null; upiVpa?: string | null } }
