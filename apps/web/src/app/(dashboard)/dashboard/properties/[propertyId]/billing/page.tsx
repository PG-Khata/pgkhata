...
import { ArrowLeft, ChevronLeft, ChevronRight, FileCheck, Play } from "lucide-react"
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b text-left text-xs text-muted-foreground">
                  ...
                  <th className="pb-2 font-medium text-right">Rent</th>
                  <th className="pb-2 font-medium text-right">Elec.</th>
              ...
              <tbody>
                {bills.map((b) => (
                  ...
                  >
                    ...
                    <td className="py-2.5 text-right font-mono">{formatCurrency(b.bill.rentAmount)}</td>
                    <td className="py-2.5 text-right font-mono">{formatCurrency(b.bill.electricityAmount)}</td>
                    <td className="py-2.5 text-right font-mono font-medium">{formatCurrency(b.bill.totalAmount)}</td>
